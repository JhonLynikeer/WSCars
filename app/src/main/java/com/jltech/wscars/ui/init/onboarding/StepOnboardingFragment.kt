package com.jltech.wscars.ui.init.onboarding
...
class StepOnboardingFragment(val step: Int) : Fragment() {
    ...
    private fun setupUI() {
        when (step) {
            ...
            STEP_THREE -> stepThreeOnboarding()
        }
    }
    ...
    private fun stepThreeOnboarding() {
        binding.apply {
            descriptionStep.text = getString(R.string.step_three_onboarding)
            imageStep.load(R.drawable.onbording_s3)
        }
    }
